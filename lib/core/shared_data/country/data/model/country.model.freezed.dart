...
class _$CountryModelImpl implements _CountryModel {
  const _$CountryModelImpl(
      {this.name, this.code, this.emoji, this.unicode, this.image});
  ...
  @override
  String toString() {
    return 'CountryModel(name: $name, code: $code, emoji: $emoji, unicode: $unicode, image: $image)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, code, emoji, unicode, image);
